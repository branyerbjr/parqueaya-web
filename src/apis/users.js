...
export const getUsers = async () => {
  try {
    const response = await axios.get('http://yapi.34.23.25.139.sslip.io/api/user/usuarios/');
...
export const updateUser = async (userId, userData) => {
  try {
    ...
    const response = await axios.put('http://yapi.34.23.25.139.sslip.io/api/user/usuarios/' + userId + '/', userData);
...
export const addUser = async (userData) => {
  try {
    const response = await axios.post('http://yapi.34.23.25.139.sslip.io/api/user/usuarios/', userData);
...
export const deleteUser = async (userId) => {
  try {
    ...
    const response = await axios.delete('http://yapi.34.23.25.139.sslip.io/api/user/usuarios/' + userId + '/');
